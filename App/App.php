...
class App
{
    ...
    public function __construct()
    {
        ...
        define('APP_HOST_ALL'       , $uri.$_SERVER['HTTP_HOST'] . "/projeto-gio-vendas/");
       ...
       /*  define('DB_HOST'        , "nathan-dev.com");
         define('DB_USER'        , "vendas_gio");
         define('DB_NAME'        , "nathande_vendas_gio");
         define('DB_PASSWORD'    , "4ouwY+k.V}R,");
        ...
        define('PATH_PUBLIC_HTML' , $uri.$_SERVER['HTTP_HOST']."/projeto-gio-vendas/public/");
       ...
       //define("PATH_REPOSITORIO_IMG" , $uri.$_SERVER['HTTP_HOST']."/App/Lib/Repositorio/fotos/");
